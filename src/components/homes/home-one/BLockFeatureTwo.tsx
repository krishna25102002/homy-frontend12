         ...
         <div className="block-feature-two mt-150 xl-mt-110">
            <div className="wrapper">
               <div className="row gx-xl-5">
                  <div className="col-xxl-7 col-md-6 d-flex">
                     <div className="block-one w-100 h-100">
                        <div className="position-relative z-1 h-100">
                           ...
                           <div className="card-box text-center">
                              <h3 className="main-count fw-500">0<span className="counter"><Count number={2} /></span>+</h3>
                              <p className="fs-20">Years offline Experience <br />with proud.</p>
                           </div>
                           {/* <img src="/assets/images/assets/screen_01.png" alt="" className="lazy-img shapes screen_01" /> */}
                        </div>
                     </div>
                  </div>
                     ...
                     <div className="block-two">
                        <div className="bg-wrapper">
                              ...
                              <div className="row">
                                 <div className="col-6">
                                    <div className="counter-block-one mt-20">
                                       <div className="main-count fw-500 color-dark"><span className="counter"><Count number={5} /></span>+</div>
                                       <span>Completed Project</span>
                                    </div>
                                 </div>
                                 <div className="col-6">
                                    <div className="counter-block-one mt-20">
                                       <div className="main-count fw-500 color-dark"><span className="counter"><Count number={1000} /></span>+</div>
                           ...
                           <div className="d-inline-flex flex-wrap align-items-center mt-15 md-mt-10">
                              <Link to="/about_us_01" className="btn-two mt-20 me-4"><span>More Details</span></Link>
