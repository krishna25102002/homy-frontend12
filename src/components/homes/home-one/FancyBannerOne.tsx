   ...
   return (
      <div className={`fancy-banner-one position-relative z-1 pt-160 xl-pt-140 lg-pt-80 pb-140 xl-pb-120 lg-pb-100 ${style ? "mt-200 xl-mt-150 lg-mt-120" : ""}`}>
         <div className={`container ${style ? "container-large" : ""}`}>
            <div className="row">
               <div className={`col-lg-6 ${style ? "col-xxl-5" : ""}`}>
                  <div className="title-one mb-45 lg-mb-30">
                     <h3 className="text-white">Exclusive <span>Monthly {style ? "" : <img src="/assets/images/shape/title_shape_04.svg" alt="" className="lazy-img" />}</span>Deal for you.</h3>
                     <p className="fs-24 text-white pe-xl-5 me-xxl-5">Don&apos;t miss out on this personalized monthly exclusive offer for you.</p>
                  </div>
                  <Link to="/listing_01" className="btn-six">More Details</Link>
               </div>

               <div className={`col-lg-6 ${style ? "ms-auto" : ""}`}>
                  <div className={`property-item md-mt-60 position-relative z-1 ${style ? "rounded-0" : ""}`}>
                     <div className="row gx-0">
                        <div className="col-md-5 d-flex">
                           <div className="gutter border-right w-100 h-100">
                              <div className="tag mb-20">RENT & SELL</div>
                              <h4 className="mb-70 sm-mb-40">Luxury Homes and PG's.</h4>
                        ...
                        <div className="col-md-7 d-flex">
                           <div className="gutter w-100 h-100">
                              <p>Banglore</p>
                              <h2 className="price text-center">Rs.10,000</h2>
                     ...
                     <div className="button-group gutter d-flex justify-content-between align-items-center">
                        <Link to="/listing_01" className="btn-three"><span>Check Full Details</span></Link>
                        <Link to="/listing_01" className="btn-four rounded-circle"><i className="bi bi-arrow-up-right"></i></Link>
                     </div>
                  </div>
               </div>
            </div>
