        ...
        {!style && (
          <div className="alert-wrapper text-center">
            <p className="fs-16 m0 text-white">
              The <Link to="/listing_01" className="fw-500">flash sale</Link> go on. The
              offer will end in — <span>This Sunday</span>
            </p>
          </div>
        )}
            ...
            <div className="d-flex align-items-center justify-content-between">
              ...
              <div className="right-widget ms-auto ms-lg-0 me-3 me-lg-0 order-lg-3">
                <ul className="d-flex align-items-center style-none">
                  ...
                  {/* Show Add Listing button only if user is logged in */}
                  {isLoggedIn && (
              ...
              <nav className="navbar navbar-expand-lg p0 order-lg-2">
                ...
                <div className="collapse navbar-collapse" id="navbarNav">
                  <NavMenu setLoginModal={setLoginModal} />
                </div>
              </nav>
            </div>
          </div>
