      ...
      <div className="footer-four position-relative z-1">
         <div className="container container-large">
               ...
               <div className="row">
                  <div className="col-xxl-3 col-lg-4 mb-60">
                     <div className="footer-intro">
                        ...
                        <p className="mb-30 xs-mb-20">Banglore,karnataka</p>
                        <Link to="#" className="email tran3s mb-60 md-mb-30">ohmprojects@gmail.com</Link>
            ...
            <div className="bottom-footer">
               <p className="m0 text-center fs-16">Copyright @2024 Tesatalogix inc.</p>
            </div>
         </div>
