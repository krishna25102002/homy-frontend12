...
const footer_data: DataType[] = [
   {
      ...
      widget_title: "Links",
      footer_link: [{ link: "/", link_title: "Home" }, 
   ...
   },
   {
      ...
      page: "home_1",
      widget_title: "Legal",
      footer_link: [{ link: "/faq", link_title: "Terms & conditions" },
   ...
   },
   {
      ...
      footer_link: [{ link: "/listing_01", link_title: "Men's PG" }, 
         { link: "/listing_01", link_title: "Women's PG" }, 
         { link: "listing_01", link_title: "Home rent" }, 
         // { link: "listing_04", link_title: "Rent Industrial" }, 
         // { link: "/listing_05", link_title: "Buy Villas" }, { link: "/listing_06", link_title: "Rent Office" },
         ]
   },
